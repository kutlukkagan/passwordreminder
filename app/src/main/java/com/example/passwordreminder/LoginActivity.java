...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            if (count == 0) {
                runOnUiThread(() -> {
                    startActivity(new Intent(LoginActivity.this, SetupAdminActivity.class));
                    finish();
                });
            }
        });
        ...
        btn.setOnClickListener(v -> {
            ...
            if (u.isEmpty() || p.isEmpty()) {
                Toast.makeText(LoginActivity.this, "Kullanıcı adı ve şifre gerekli", Toast.LENGTH_SHORT).show();
                return;
            }
